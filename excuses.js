const excuses = [
    ...
    "My dependencies got deleted for some reason and it took a long time reinstalling.",
    "I didn't have enough time to test the code.",
    "I encounted a security issue and had to fix it before my system gets compromised.",
    "A TROJAN!!!"
];
...
const school = [
    ...
    "I was having issues with my internet connection.",
    "I had to attend to a pet's urgent needs.",
    "I was dealing with an important paperwork.",
    "I had to visit a specialist.",
    "I had an unexpected travel delay.",
    "I had a home repair emergency.",
    "I had to resolve a billing issue.",
    "I was attending a religious service.",
    "I had to manage a time-sensitive issue.",
    "I had to complete a job application.",
    "I had to take care of a legal matter.",
    "I had a health-related appointment.",
    "I had an urgent personal task.",
    "I was helping with a community event.",
    "I had a pressing family issue.",
    "I had an essential task to complete.",
    "I was attending a family gathering.",
    "I had to handle an unexpected obligation.",
    "I was experiencing severe personal stress.",
    "I had a last-minute family event.",
    "I had to deal with a work-related issue.",
    "I had a mandatory appointment.",
    "I had an urgent issue with my residence.",
    "I was experiencing significant fatigue.",
    "I had to attend a critical seminar.",
    "I had to handle an important family matter.",
    "I was dealing with a last-minute conflict.",
    "I had a health concern that needed attention.",
    "I had to manage a personal crisis.",
    "I had to deal with an essential task at home.",
    "I had to attend to a personal emergency.",
    "I was experiencing a significant interruption.",
    "I had to complete an urgent personal task.",
    "I was involved in a necessary community service.",
    "I had to address an unexpected problem.",
    "I had a critical family obligation.",
    "I had to manage a time-sensitive issue.",
    "I was dealing with an unexpected health problem.",
    "I had a family member who needed urgent assistance.",
    "I had to attend a crucial personal meeting.",
    "I was handling a time-sensitive matter.",
    "I had to deal with an important appointment.",
    "I had to resolve an urgent issue with my residence.",
    "I had an unexpected family commitment.",
    "I was dealing with a personal obligation.",
    "I had to attend an important workshop.",
    "I had a necessary personal engagement.",
    "I was dealing with a time-sensitive situation.",
    "I had to manage an unexpected family need.",
    "I had to attend to an urgent personal issue.",
    "I was involved in a pressing community event."
];
...
function normalExcuse() {
    const randomIndex2 = Math.floor(Math.random() * normal.length);
    const norexcuse = normal[randomIndex2];
    document.getElementById('normal').innerText = norexcuse;
}

function schoolExcuse() {
    const randomIndex3 = Math.floor(Math.random() * school.length);
    const schexcuse = school[randomIndex3];
    document.getElementById('school').innerText = schexcuse;
}
